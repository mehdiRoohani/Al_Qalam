...
import matcher.ContainsMatcher;
...
public class JSuggestField extends JTextField {
	...
	private ContainsMatcher suggestMatcher = new ContainsMatcher();
    ...
    public void setSuggestSize(int width, int height) {
	...
	public void setSuggestMatcher(SuggestMatcher suggestMatcher) {
		this.suggestMatcher = (ContainsMatcher) suggestMatcher;
	}
